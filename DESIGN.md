...
| Name | Value | Role |
|------|-------|------|
| Basalt Canvas | `#e2e2df` | Page backgrounds, subtle card surfaces for secondary information blocks |
| Ash White | `#f7f6f2` | Primary card surfaces, button backgrounds, element containers |
| Abyssal Ink | `#070607` | Heading text, primary body text, strong borders |
| Pure White | `#ffffff` | Input text, icon fills against dark backgrounds, text on filled buttons |
| Digital Orange | `#fc5000` | Primary action buttons, prominent card backgrounds, brand accents—commands attention with playful energy |
| Cyber Violet | `#524ae9` | Decorative background shapes, accent cards within complex graphics |
| Pixel Glare | `#f5f28e` | Highlight overlays, graphic accents, subtle background patterns for visual texture |
...
### PP Neue Corp Compact Ultrabold — Display and heading text. Its ultrabold weight and compact form define the brand's assertive, almost shouting voice. Tight letter-spacing reinforces the density.
...
### DM Sans — Body text, navigation links, and input labels. Provides readability and a modern, slightly geometric counterpoint to the display font.
- **Substitute:** Inter
- **Weights:** 500
...
| body-sm | 14px | 1.25 | — |
| body | 16px | 1.55 | — |
| subheading | 30px | 1.11 | — |
| heading-sm | 32px | 0.95 | 0.02px |
| heading | 56px | 0.94 | 0.02px |
| display | 96px | 0.94 | 0.02px |
