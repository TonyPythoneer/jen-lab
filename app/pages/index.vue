<template>
  ...
  <div class="flex flex-col sm:flex-row min-h-screen">
    <HomeToc :links="navLinks" :title="selectedProfile.label" />
      ...
      <div class="w-full max-w-lg px-4 sm:px-8 flex flex-col gap-5">
        ...
        <ClientOnly>
          <Transition name="tab-drop" appear>
            <UTabs v-model="selectedProfileKey" :items="profileTabs" size="sm" class="pt-5" />
          </Transition>
          <template #fallback>
        ...
        <HomeProfile v-if="page" id="profile" :profile="page.profile" />
...
const profileQueries = {
  "jen-knows": useLazyAsyncData("profile:jen-knows", () =>
    queryCollection("home").path("/home/jen-knows").first(),
  ),
  "jen-liu": useLazyAsyncData("profile:jen-liu", () =>
