...
export const restaurants = [
  {
    ...
    description:
      "很多分店，但是景色最美的話要選Barangaroo靠窗邊的位子。袋鼠肉的烤肉串蠻出名的味道也不錯，可以嘗試。牛排最喜歡Rib Eye但是個人認為不需要點到wagyu等級, oconnor mb3+就很不錯了，如果要嘗試的話可以試試看。強烈推薦把配菜換成mash potato 或者 sweet potato chips，真的好吃! 甜點一般，建議留下肚子去吃隔壁的冰淇淋。",
    priceRange: "$$$",
    recommendations: ["Rib Eye", "豬肋排串", "Mash Potato"],
  ...
  },
  {
    ...
    description:
      "會沒收手機的神奇餐廳，入口頗隱蔽在一個地下室。牛排點rib eye 300gm那個中間部位的最好吃。除了牛排之外，最驚豔的居然是袋鼠肉，處理得很好! Medium Rare熟度剛好，很嫩也有足夠的咬勁。配菜烤南瓜很讚，甜點推薦buttermilk ice cream，有切碎的蜂巢，口感層次豐富。",
    priceRange: "$$$",
    recommendations: ["Rib Eye 300gm", "豬肋排", "Buttermilk Ice Cream"],
  ...
  },
  {
    ...
    description:
      "一定要點牛排，推薦安格斯牛medium rare，最能吃到很嫩的口感。豬排其實也很好吃，醬是微甜的! 肉份量都巨無霸。推薦松露牛骨髓義大利麵，骨髓的油脂感搭配松露香氣是絕配!!",
    priceRange: "$$$$",
    recommendations: ["頂級木炭烤 Medium Rare", "裸骨義大利麵"],
  ...
  },
  {
    ...
    description:
      "超近距離正對歌劇院的fine dining。Lamington口味的調酒超好喝，爆米花+玉米泥口味的前菜很特別。每季度都會換菜單。",
    priceRange: "$$$$",
    recommendations: ["Lamington 甜點", "牛肉主菜"],
  ...
  },
  {
    ...
    description:
      "日料Fine Dining，每季有不同的菜單。每道菜都很驚豔，但價格也很精艷XD 需要慢慢品嘗!",
    priceRange: "$$$$",
    recommendations: ["每季套餐"],
  ...
  },
  {
    ...
    description:
      "主餐個人覺得還好，重點甜點好吃種類又很多，推薦下午茶的時段去不用排隊。甜點招牌流心鹹蛋黃球、泰奶Bingsu。",
    priceRange: "$$",
    recommendations: ["流沙鹹蛋黃", "泰奶 Bingsu"],
  ...
  },
  {
    ...
    description:
      "雪梨最有名的泰餐連鎖，CP值很高基本上點什麼都不會雷。要注意辣度，有辣的菜是真的很辣。有些分店不能預約要現場排隊建議事先打電話問。",
    priceRange: "$$",
    recommendations: ["Pad Thai", "Som Tum"],
  ...
  },
  {
    ...
    description:
      "這家的生醃蝦超級無敵好吃!! 其他的泰式小吃也很棒，缺點是座位比較小一點，有點擁擠。",
    priceRange: "$$",
    recommendations: ["酸辣蝦"],
  ...
  },
  {
    ...
    description:
      "這家有生醃蝦+木瓜沙拉+生魚片的套餐。沙拉很辣，要跟店員說mild。有一種湯Guay Jub喝起來有台式牛肉麵的感覺，濃濃的中藥感，超愛。",
    priceRange: "$$",
    recommendations: ["酸辣蝦套餐", "Guay Jub 湯"],
  ...
  },
  {
    ...
    description:
      "生醃蝦有蒜瓣+芥末，很嗆很過癮。打拋豬要挑掉綠辣椒不然很辣。蒸魚酸甜微辣的調味蠻好吃的，記得把醬汁淋上去讓魚肉多沾點醬味。",
    priceRange: "$$",
    recommendations: ["酸辣蝦", "烤柳橙", "烤鴨腿"],
  ...
  },
  {
    ...
    description:
      "專門喝湯的，只要湯類都很好，個人推薦牛骨湯。生牛肉石鍋拌飯不錯。續小菜現在要加錢了，要注意。",
    priceRange: "$$",
    recommendations: ["牛骨湯", "牛骨涮涮鍋"],
  ...
  },
  {
    ...
    description:
      "每道料理都便宜又大碗，無論是辣醬炒豬肉，還是豬骨湯、海鮮煎餅、炸雞，樣樣都口味正宗不踩雷。最推薦的菜色是炸排骨。",
    priceRange: "$$",
    recommendations: ["烤五花", "辣炒豬頸肉", "豬骨湯"],
  ...
  },
  {
    ...
    description:
      "雪梨市區日燒應該算最有名的了，肉質沒話說! 食量不錯的朋友也可以直接選吃到飽，有包含生魚片跟壽司~",
    priceRange: "$$$",
    recommendations: ["吃到飽", "牛魚子", "壽司"],
  ...
  },
  {
    ...
    description:
      "居酒屋，客人多數是日本人味道很正宗，好吃的有山藥明太子、生魚片、烤鯖魚、炸茄子等等。",
    priceRange: "$$",
    recommendations: ["山葵鮭太子", "牛魚子", "定食魚魚"],
  ...
  },
  {
    ...
    description:
      "會有點摩斯漢堡感覺的米漢堡，只是形狀不一樣，餡料也是西式的漢堡肉排起司餡，但是超級好吃!",
    priceRange: "$$",
    recommendations: ["米漢堡"],
  ...
  },
  {
    ...
    description:
      "拉麵湯頭又甜又香，可以選有三種不同的肉那款，裡面有鴨肉，很好吃。要在中午12點前去，排隊超過10分鐘就完全不值得了。",
    priceRange: "$$",
    recommendations: ["鰻魚拉麵"],
  ...
  },
  {
    ...
    description:
      "店面、服務生跟顧客都會讓人有種到了日本的感覺! 中午的便當可以吃到很豐富的菜品，非常划算又好吃。",
    priceRange: "$$",
    recommendations: ["中午便當"],
  ...
  },
  {
    ...
    description:
      "在Surry Hills，炸豬排真的超級好吃! Kingfish的醬汁跟配菜蠻特別的。。價格偏貴，要慎重。",
    priceRange: "$$$",
    recommendations: ["炸豬排", "Kingfish"],
  ...
  },
  {
    ...
    description:
      "雪梨川菜十年不倒常勝軍。麻婆豆腐、酸湯肥牛、乾鍋花菜、口水雞、魚香茄子… 啊實在太多了，總之每一道都好吃!",
    priceRange: "$$",
    recommendations: ["麻婆豆腐", "酸湯肥牛", "乾鍋花菜"],
  ...
  },
  {
    ...
    description:
      "唐人街比較新的港式飲茶。推薦鳳爪，醬很入味膠質感很夠。舂風得意這道菜上最快的一家。",
    priceRange: "$$$",
    recommendations: ["鳳爪", "舂風得意"],
  ...
  },
  {
    ...
    description:
      "懷念台灣口味的可以來這家福記，豬腳飯口味跟台灣有87分像。沙茶牛肉粿條也很像。生醃螯蝦非常有味。",
    priceRange: "$$",
    recommendations: ["豬肉飯", "沙茶炒肉粿條", "牛肉湯"],
  ...
  },
  {
    ...
    description:
      "老闆夫妻一位是台灣人一位東南亞，所以菜系比較廣，但是隨便點都好吃，尤其是沙茶羊肉，真的很有鍋氣，秒回台灣的熱炒感! 滷肉則是入口即化，都很下飯。",
    priceRange: "$$",
    recommendations: ["滷蛋", "沙茶空心菜"],
    googleMapsLink: "",
  ...
  },
  {
    ...
    priceRange: "$$",
    recommendations: ["Roti Canai", "Satay Chicken"],
  ...
  },
  {
    ...
    description:
      "通常網路上都有Groupon可以買，three course menu是很划算的。座位選靠窗看Darling Harbour。推前菜招牌蝸牛跟鴉胸。",
    priceRange: "$$$",
    recommendations: ["蒜香蝸牛", "鴨肉"],
  ...
  },
  {
    ...
    priceRange: "$$$$",
    recommendations: ["蝸牛", "麵包", "大腸", "Blue Eye Cod"],
  ...
  },
  {
    ...
    priceRange: "$$$$",
    recommendations: ["韃靼牛肉 Tartare", "Kingfish 刺身", "鵝肝"],
  ...
  },
  {
    ...
    priceRange: "$$$",
    recommendations: ["現烤麵包", "Burrata cheese", "Kingfish"],
  ...
  },
  {
    ...
    description:
      "Tapas店，空間很小所以建議早點到，基本怎麼點都不雷。最愛King Prawn，超大超鮮甜，蝦油很香。",
    priceRange: "$$",
    recommendations: ["King Prawn", "Tapas"],
  ...
  },
  {
    ...
    description:
      "適合慶生或特殊節日吃的類fine dining。中東人最擅長的烤雞必點，一咬下去直接爆汁不誇張。魚有Murray Cod也是經典。",
    priceRange: "$$$$",
    recommendations: ["烤肉花椰菜", "中東拼盤"],
  ...
  },
  {
    ...
    priceRange: "$$$",
    recommendations: ["羊肩", "烤茄子配烤蝦", "開心果冰淇淋"],
  ...
  },
  {
    ...
    priceRange: "$",
    recommendations: ["Italian Nougat", "Honey Pockey", "開心果"],
  ...
  },
  {
    ...
    priceRange: "$$",
    recommendations: ["抹茶爆漿可頌", "hojicha"],
  ...
  },
  {
    ...
    description:
      "Panna Cotta Lamington真的是一絕，想要很澳洲，必吃!但強烈推薦不要一個人吃，因為很甜。",
    priceRange: "$$",
    recommendations: ["Panna Cotta Lamington"],
  ...
  },
  {
    ...
    priceRange: "$$",
    recommendations: ["巴斯克蛋糕", "可頌 Danish"],
  ...
  },
  {
    ...
    priceRange: "$$",
    recommendations: ["開心果鹹塔", "夏季限定芒果椰子丹麥塔", "三明治"],
  ...
  },
  {
    ...
    priceRange: "$",
    recommendations: ["咖啡豆", "沙拉", "雞蛋卷", "法式吐司"],
  ...
  },
  {
    ...
    description:
      "推薦招牌柚子冷粹(Yuzu Cold Brew)，酸甜與咖啡苦韻完美平衡，夏天的最愛。大白兔口味也好喝，上面是一層甜甜的奶蓋。",
    priceRange: "$",
    recommendations: ["拿鐵", "大白咖啡"],
  ...
  },
  {
    ...
    description:
      "隱藏在二樓，是只有上班族會去的店。空間超大、環境超好，適合職場Coffee Chat或聊工作。",
    priceRange: "$",
    recommendations: ["Coffee Chat"],
  ...
  },
  {
    ...
    description:
      "入口很隱蔽，但進去之後別有洞天。免費的蝴蝶脆餅(pretzels) 很讓人上癮。cider很好喝。",
    priceRange: "$$$",
    recommendations: ["Cider", "Pretzels"],
  ...
  },
  {
    ...
    priceRange: "$$",
    recommendations: ["漢堡", "Poutine", "Loaded Fries"],
  ...
  },
  {
    ...
    priceRange: "$$$",
    recommendations: ["格子雞尾酒", "泰奶椰子雞尾酒", "辣味爆米花"],
  ...
  },
  {
    ...
    priceRange: "$",
    recommendations: ["當季水果茶", "龍珠椰子凍", "橘子凍"],
  ...
  },
  {
    ...
    description:
      "嚼感派首推，特製的各種配料都超好吃，尤其是黑糖粉粿是必點。記得小料本來就都是甜的，所以點的時候半糖/少糖就好，例如紅茶拿鐵+黑糖粉粿、芭樂檸檬綠茶+白珍珠",
    priceRange: "$",
    recommendations: ["紅茶拿鐵+黑糖粉粿", "芭樂綠茶+白珍珠"],
    googleMapsLink: "",
