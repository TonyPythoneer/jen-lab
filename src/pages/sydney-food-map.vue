...
// The atlas serif stack (Crimson Pro + Noto Serif TC) loads site-wide from the
// Google Fonts link built off src/config/site.ts, so no per-page font link is needed.
